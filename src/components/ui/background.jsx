...
export const AuroraBackground = ({
  ...
  return (
    <div
      className={cn(
        "transition-bg relative text-slate-950 dark:bg-zinc-900", // Removed bg-zinc-50
        className
      )}
      {...props}
    >
      <div
        ...
        style={{
          ...
          // Remove or comment out --white-gradient if you don't want it:
          // "--white-gradient":
      ...
      >
        <div
          className={cn(
            `after:animate-aurora absolute -inset-[10px]
            [background-image:var(--aurora)]
            [background-size:300%_200%]
            [background-position:50%_50%]
            opacity-80 blur-[10px] invert filter will-change-transform
