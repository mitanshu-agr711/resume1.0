...
const ResumeUpload = ({ colorMode }) => {
  ...
  return (
    <>
      <section id="file-upload" className={`pt-28 md:pt-32 pb-40 md:pb-28 page-section min-h-screen py-10 px-4 ${colorMode === 'light' ? 'text-black' : 'text-white'}`}>
        <div className="max-w-6xl ">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Upload Your Resume</h2>
            <p className={`text-lg text-gray-600 max-w-2xl mx-auto ${colorMode === 'light' ? 'text-gray-600' : 'text-white'} `}>
              Drag and drop your resume file or click to browse. We support PDF, DOCX, JPG, and PNG formats.
            </p>
          </div>

          <div className=" md:flex-cols-2 gap-10 flex items-center justify-center">
              ...
              >
                {!uploading && !processing && files.length === 0 && (
                  <div>
                    ...
                    <p className={`text-lg font-medium text-gray-700 mb-2 ${colorMode === 'light' ? 'text-gray-800' : 'text-white'} `}>Drag & Drop your resume here</p>
                    <p className={`text-sm text-gray-500 mb-4 ${colorMode === 'light' ? 'text-gray-600' : 'text-white'} `}>Or click to browse files</p>
                    <Button 
                    ...
                    <p className={`mt-2 text-xs text-gray-500 ${colorMode === 'light' ? 'text-gray-800' : 'text-white'} `}>Supported formats: PDF, DOCX, JPG, PNG</p>
                  </div>
                )}
